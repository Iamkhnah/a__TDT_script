...
_G.Color = Color3.fromRGB(149, 162, 246)
...
function library:Evil()
	...
	Title.BackgroundColor3 = Color3.fromRGB(149, 162, 246)
	Title.BackgroundTransparency = 1.000
	Title.Position = UDim2.new(0.05, 0, 0.04, 0)
	Title.Size = UDim2.new(0, 483, 0, 31)
	Title.Font = Enum.Font.GothamBold
	Title.Text = "<font color='rgb(255, 0, 0)'>TDT Hub</font>" .. " - Blox Fruit - " .. getgenv().Device
	Title.RichText = true;
	...
	Menu_Setting.Image = "http://www.roblox.com/asset/?id=11446900930"
	...
	UIGradient.Color = ColorSequence.new {
		...
		ColorSequenceKeypoint.new(0.29, Color3.fromRGB(255, 0, 0)),
		ColorSequenceKeypoint.new(0.50, Color3.fromRGB(255, 0, 0)),
		ColorSequenceKeypoint.new(0.68, Color3.fromRGB(170, 0, 0)),
	...
	spawn(function()
		while wait(0.001) do
          ...
          {
					Size = UDim2.new(game.Players.LocalPlayer.Character.Energy.Value / game.Players.LocalPlayer.Character.Energy.MaxValue, 0, 1, 0)
